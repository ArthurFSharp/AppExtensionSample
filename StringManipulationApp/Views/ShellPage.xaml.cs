...
using StringManipulationApp.Helpers;
using StringManipulationApp.Services;
...
namespace StringManipulationApp.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<ExtensionsViewPage>("Shell_ExtensionsView".GetLocalized(), Symbol.Document));
        }
